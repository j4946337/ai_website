  ...
  return (
    ...
    >
      ...
      >
        ...
        <Home1 currentLanguage={currentLanguage} />
        <Home2 currentLanguage={currentLanguage} />
        <Home3 currentLanguage={currentLanguage} />
        <Home4 currentLanguage={currentLanguage} />
        <Home5 currentLanguage={currentLanguage} />
        <Home5_1 currentLanguage={currentLanguage} />
        <Home6 currentLanguage={currentLanguage} />
        <Home7 currentLanguage={currentLanguage} />
        <Home8 currentLanguage={currentLanguage} />
        <Home9 currentLanguage={currentLanguage} />
      </main>
    </div>
  )
}
