...
const Home4 = () => {
  return (
    <div className="w-full h-[1687px] bg-[#0a1650] relative  overflow-hidden">
      <img src={BRAIN} className="absolute mx-auto top-[239px] left-[50%] translate-x-[-55%]" alt="" />
      <div className="flex flex-col items-center pt-[95px]">
        <p className="text-[#ffffff] text-[80px] font-semibold ">YOUR LIBERATION</p>
        <p className="text-[#94a4f2] text-[38px] mt-[-25px]   font-light ">ME AI  |  Your Freedom</p>
      </div>
      {/* left  start*/}
      ...
      {/* right down end */}
      {/* part2 start */}
      <div className="flex justify-between absolute top-[570px] left-0 ">
        <div className="relative">
          <img src={PEOPLE} alt="" className=" max-w-full max-h-full object-cover   z-20 " />
        </div>
