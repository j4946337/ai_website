...
const Home5 = () => {
  return (
    <div className="w-full h-[775px] overflow-hidden bg-[#0a1650]">

      <div className="flex justify-between flex-col items-center pt-[60px] text-nowrap">
        <p className="z-0 text-[#ffffff] text-[80px] font-semibold">YOUR JOURNEY, STEP-BY-STEP</p>
        <p className="text-[#94a4f2] font-light text-[38px] mt-[-25px]">How You Earn Your ME Tokens?</p>
      </div>
