...
const Home7 = () => {
  return (
    < div className="w-full h-[775px] bg-[#0a1650] relative  overflow-hidden">
      <img src={me_imf} alt="me_imf" className='absolute h-[670px] z-30 top-[59px] right-0 translate-x-[25%]' />
      <div className="pt-[85px] pl-[9%]">
        <div>
      ...
      <div className='mt-[100px] flex m-auto gap-[4%] w-[86%] ml-[9%]'>
        <div className='left_7 flex flex-col gap-[31px]'>
        ...
        <div className='middle_7'>
          <img src={chart} alt="chart" className='w-[481px] h-[283px]' />
        </div>
        <div className='right_7 flex flex-col gap-[31px]'>
          <div className='flex flex-col'>
            <div className='flex items-center'>
